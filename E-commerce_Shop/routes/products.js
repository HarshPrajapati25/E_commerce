...
router.get(`/:id`, async (req, res) => {
    const product = await Product.findById(req.params.id).populate('category'); //populate is use to add from diff file
...
router.delete('/:id', async (req, res) => {
    let product = await Product.findOneAndDelete(req.params.id).then(product => {
        if (product) {
